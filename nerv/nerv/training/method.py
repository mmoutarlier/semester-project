...
from nerv.nerv.utils.io import check_file_exist, mkdir_or_exist
from nerv.nerv.utils.misc import AverageMeter, MeanMetric
from nerv.nerv.utils.tensor import ddp_all_gather
from nerv.nerv.utils.conversion import is_list_of
from nerv.nerv.training.lr import get_lr
from nerv.nerv.training.model import BaseModel
from nerv.nerv.training.params import BaseParams
from nerv.nerv.training.datamodule import BaseDataModule
from nerv.nerv.models.utils import filter_wd_parameters
...
class BaseMethod(nn.Module):
    ...
    def _init_env(self):
        ...
        - DDP training
        """
        self.gpus = torch.mps.device_count()
        ...
        if self.use_ddp:
            ...
            self.device = torch.device(f'mps{self.local_rank}')
        else:
